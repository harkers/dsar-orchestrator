...
# Register helpers live in a separate leaf module so module_agents (which
# also needs them per Contract A / issue #8) doesn't have to import
# hash_chain — that would violate import-linter contract 7.
from dsar_orchestrator.register import (  # noqa: F401 — re-exported
    read_register,
    read_register_meta,
    text_path_for_ref,
    write_register_meta,
